...
const OUTPUT_DIR = path.join(PROJECT_ROOT, 'outputs', 'c4-brasil-inteiro-reels');
const OUTPUT_FILE = path.join(OUTPUT_DIR, 'c4_brasil_inteiro_reels.mp4');
...
async function main() {
  ...
  console.log('Selecting composition C4BrasilInteiroReels...');
